...
test_root_dir = '/home/pirl/Desktop/OCR/FAST/data/sample_ocr'
test_train_data_dir = test_root_dir + 'train/imgs/'
test_train_gt_dir = test_root_dir + 'train/gts/'
test_test_data_dir = test_root_dir + 'test/imgs/'
test_test_gt_dir = test_root_dir + 'test/gts/'
...
class test(data.Dataset):
    def __init__(self, split='train', is_transform=False, img_size=None, short_size=736,
        ...
        if split == 'train':
            data_dirs = [test_train_data_dir] * repeat_times
            gt_dirs = [test_train_gt_dir] * repeat_times
        elif split == 'test':
            data_dirs = [test_test_data_dir]
            gt_dirs = [test_test_gt_dir]
        else:
...
if __name__ == '__main__':
    ...
    test_test_data_dir = test_root_dir + 'test/imgs/'
    test_test_gt_dir = test_root_dir + 'test/gts/'
    dataloader = test(split='train', is_transform=False, img_size=736,
