...
from dataset.utils import get_sample_ann as get_ann
...
sample_root_dir = '/home/pirl/Desktop/OCR/FAST/data/1024_OCR/sample_100/'
sample_train_data_dir = sample_root_dir + 'imgs/'
sample_train_gt_dir = sample_root_dir + 'gts/'
sample_test_data_dir = sample_root_dir + 'imgs/'
sample_test_gt_dir = sample_root_dir + 'gts/'
...
class Sample(data.Dataset):
    def __init__(self, split='train', is_transform=False, img_size=None, short_size=736,
        ...
        if split == 'train':
            data_dirs = [sample_train_data_dir] * repeat_times
            gt_dirs = [sample_train_gt_dir] * repeat_times
        elif split == 'test':
            data_dirs = [sample_test_data_dir]
            gt_dirs = [sample_test_gt_dir]
        else:
...
if __name__ == '__main__':
    ...
    sample_root_dir = '/home/pirl/Desktop/OCR/FAST/data/1024_OCR/sample_100'
    sample_train_data_dir = sample_root_dir + 'train/imgs/'
    sample_train_gt_dir = sample_root_dir + 'train/gts/'
    sample_test_data_dir = sample_root_dir + 'imgs/'
    sample_test_gt_dir = sample_root_dir + 'gts/'

    dataloader = Sample(split='train', is_transform=False, img_size=736,
